...
async function ejecutarCargaSeleccion() {
  ...
  if (!token) {
    grid.innerHTML = `
            <div class="col-span-full flex flex-col items-center justify-center py-32 gap-6">
                ...
                <p class="text-slate-500 text-center tracking-widest uppercase text-xs">Enlace no válido.<br/>Contacta con Juan para obtener tu enlace.</p>
            </div>`;
    return;
  }
  ...
  if (i === 1) {
    grid.innerHTML = `
            <div class="col-span-full flex flex-col items-center justify-center py-32 gap-6">
                ...
                <p class="text-slate-500 text-center tracking-widest uppercase text-xs">Este muestrario aún no tiene fotos.<br/>Contacta con Juan.</p>
            </div>`;
  }
}
